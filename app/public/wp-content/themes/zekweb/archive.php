            ...
            while (have_posts()):
              ...
              if ($post_count === 1): ?>
                <div class="momneadknow-banner mb-4">
                  ...
                  <a class="momneadknow-banner__title"
                  ...
                  <div class="col-lg-4 col-6">
                    <div class="momneadknow-blog">
                      ...
                      <div class="momneadknow-blog__body">
                        <a class="momneadknow-blog__title"
                          href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                  ...
                  foreach ($posts as $post):
                    ...
                    <div class="momneadknow-item__item">
                      <figure>
                        <a href="<?php the_permalink(); ?>">
                          <img
                            src="<?php the_post_thumbnail_url('large', ['alt' => get_the_title()]); ?>"
                            alt="<?php echo get_the_title(); ?>">
                        </a>
                      </figure>
                      <div>
                        <a class="momneadknow-sidebar__title"
                          href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
