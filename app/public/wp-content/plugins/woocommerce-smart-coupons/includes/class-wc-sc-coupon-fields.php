						...
						<?php
							woocommerce_wp_checkbox(
								array(
									...
									'description' => __( 'Allow users to choose when multiples are added on the above. <br> ( <span style="color: red;font-style: italic;margin-top: 10px;"> <b> Note: Currently, this feature is available for WooCommerce Blocks only. </b> </span> )', 'woocommerce-smart-coupons' ),
								)
							);
						?>
					</p>
