...
<div class="supports">
  ...
  <div class="item">
    <a href="tel:<?php the_field('hotline', 'option'); ?>"
      ...
      <img
        src="<?php bloginfo('template_url'); ?>/assets/images/support-hotline.png"
        alt="icon">
    </a>
  </div>
  <!-- Messenger -->
  <div class="item">
    <a href="http://zalo.me/<?php the_field('zalo', 'option') ?>"
      ...
      <img
        src="<?php bloginfo('template_url'); ?>/assets/images/support-zalo.png"
        alt="icon">
    </a>
  </div>
  <!-- Messenger -->
  <div class="item">
    <a href="https://m.me/<?php the_field('messenger', 'option') ?>"
      ...
      <img decoding="async"
        src="<?php bloginfo('template_url'); ?>/assets/images/support-messenger.png"
        alt="icon">
    </a>
  </div>
</div>
